...
let inventory = [
  ...
  console.log(`Car 33 is a ${inventory[32].car_make} , car year:${inventory[32].car_year},  car make: ${inventory[32].car_make}, car model: ${inventory[32].car_model}`);
  
  // ==== Challenge 2 ====
  // The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
  let lastCar = inventory.length -1;
  console.log(`The Last Car info:\ncar_make: ${inventory[lastCar].car_make}, car_model: ${inventory[lastCar].car_model}`);
  ...
  let oldCars = [];
  for(const old in carYears)
    if(carYears[old] < 2000)
      oldCars.push(carYears[old])
