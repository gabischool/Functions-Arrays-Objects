...
console.log(`Car 33 is a * (inventory(i). car year goes here* *inventory[i].car make goes here* *car model goes here*`);
  }
  ...
  let lastCar = 0;
  console.log(inventory[inventory.indexOf-1]).car_make;

console.log(inventory[inventory.indexOf-1]).car_model;
